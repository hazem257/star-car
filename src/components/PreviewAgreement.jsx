  ...
  return (
    <div style={{ padding: "2rem", direction: "rtl", fontFamily: "Cairo, sans-serif" }}>
      ...
      <div ref={refAgreement} className="agreement">
        ...
        {/* التكاليف */}
        <div className="table-title" style={{direction: "ltr"}}>Data </div>
        <table className="contract-table cost-table">
          <tbody style={{ direction: "rtl" }}>
            ...
            <tr><td>Expected Return date</td><td>{form.expectedReturnDate}</td></tr>
            <tr><td>Km (IN)</td><td>{form.kmIn || 0} Km</td></tr>
            <tr><td>Km (OUT)</td><td>{form.kmOut || 0} Km</td></tr>
            <tr><td>Km's Driver </td><td>{form.driversKm || 0} Km</td></tr>
            <tr><td> km Allowance</td><td>{form.allowance || 0} Km</td></tr>
            <tr><td>EXT </td><td>{form.kmIncrease || 0} Km's</td></tr>
          </tbody>
        </table>
        <div className="notes">
